...
import { Movie, TmdbSearchResponse, TVShow, WatchProviderOptions } from "../types/tmdb";
...
export const tmdbRouter = createTRPCRouter({
  search: publicProcedure
    ...
    .query(async({ input }) => {
      ...
      const results = (data.results as TmdbSearchResponse['results'])
  ...
  providers: publicProcedure
    ...
    .query(async({ input: { id, type } }) => {
      ...
      const providers = data.results.US as WatchProviderOptions;
